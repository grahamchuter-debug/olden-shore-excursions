...
export const oldenWalkingTourExcursion: ExcursionData = {
  ...
  highlights: [
    ...
    "Local history and Nordfjord culture",
  ...
  description: [
    "When your port time is limited, a guided walk through Olden delivers authentic Norwegian village atmosphere without long road transfers. The compact layout means you are never far from the cruise pier while still discovering local history, harbour views, and the mountain backdrop that defines this Nordfjord port.",
  ...
  included: [
    ...
    "Commentary on local history and Nordfjord culture",
